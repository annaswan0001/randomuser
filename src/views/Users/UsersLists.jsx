...
import { usersInit, usersFilter } from "../../redux/actions/usersAction";
...
function Users(props) {
  ...
  const { users, usersInit, usersFilter } = props;
    ...
    <div>
      ...
      {props.users &&
        props.users.map((user) => (
          <UserList  key={user.login.uuid} user={user} />
        ))}
    </div>
  );
}
...
export default connect(mapStateToProps, { usersInit, usersFilter })(Users);
